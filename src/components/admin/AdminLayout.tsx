...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-ds-bg overflow-hidden">
      ...
      <aside
        className={cn(
          "w-56 bg-ds-surface text-ds-text flex flex-col shrink-0",
      ...
      >
        {/* Brand */}
        <div className="px-5 py-5 border-b border-ds-border flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-ds-muted mt-0.5">Admin Portal</p>
            </div>
          </div>
          <button
            className="md:hidden p-1 rounded-lg text-ds-muted hover:text-ds-text hover:bg-ds-card transition-colors"
            onClick={() => setSidebarOpen(false)}
          >
            <X className="h-4 w-4" />
          </button>
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        {/* Top bar */}
        <header className="flex items-center gap-3 px-4 md:px-6 h-14 border-b border-ds-border bg-ds-surface shrink-0">
          <button
            className="md:hidden p-2 rounded-xl text-ds-muted hover:bg-ds-card transition-colors shrink-0"
          ...
          {/* Logo — mobile only */}
          <div className="flex items-center gap-2 font-bold text-sm text-ds-text md:hidden">
